...
3. On the **Basics** page, configure the following options:
    ...
    ![Create AKS cluster - provide basic information](/xamk-challenges/_posts/post-media/create-cluster-basics.png)
    ![Image](/xamk-challenges/media/metatavu-logo.png)
...
![Open the Azure Cloud Shell in the portal](/docs/_posts/post-media/aks-cloud-shell.png)
